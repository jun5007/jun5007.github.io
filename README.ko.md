...
[이석준의 한국어 포트폴리오](https://jun5007.github.io/ko/) 소스 저장소입니다. 선별한 AI·데이터 프로젝트, 대회 기록, 논문 1편, 자격 정보를 근거와 재현성 한계가 분명하게 드러나도록 정리했습니다.

## 언어별 경로

- English (기본): [https://jun5007.github.io/](https://jun5007.github.io/)
- 한국어: [https://jun5007.github.io/ko/](https://jun5007.github.io/ko/)

두 페이지는 같은 섹션 순서와 사실 범위를 사용합니다. 언어를 전환할 때는 가능한 경우 현재 섹션 위치를 유지합니다.
...
- 논문은 “환율 민감도 기반 클러스터링과 동조지수를 이용한 산업별 월간 수익률 예측” 1편만 표시하며, 이석준의 역할은 **Co-author**입니다.
- Google Analytics Certification은 **2026-06-12**에 발급되어 **2027-06-12**까지 유효합니다. 인증서 ID와 PDF는 공개하지 않습니다.
